...
const languages: {
    ...
    go: {
        ...
        colorizer: new Colorizer.ColorizerGo(),
    },
    cpp: {
        module: 'tree-sitter-cpp',
        colorizer: new Colorizer.ColorizerCpp(),
    },
    rust: {
        module: 'tree-sitter-rust',
        colorizer: new Colorizer.ColorizerRust(),
    },
    ruby: {
        module: 'tree-sitter-ruby',
        colorizer: new Colorizer.ColorizerRuby(),
    },
    typescript: {
        module: 'tree-sitter-typescript',
        colorizer: new Colorizer.ColorizerTS(), //would like for this to work and not be idle.
    },
    javascript: {
        module: 'tree-sitter-javascript',
        colorizer: new Colorizer.ColorizerTS(),
    },
};
        ...
        parts.forEach(part => {
            switch (part) {
                case 'italic':
                    ...
                    break;
                case 'bold':
                    options.fontWeight = 'bold'; // this might be able to be used with the new grammar to check if it's a preproc thin or enum.
                    break;
                case 'underline':
...
export async function activate(context: vscode.ExtensionContext) {
    ...
    async function onChangeConfiguration(event: vscode.ConfigurationChangeEvent) {
        let colorizationNeedsReload: boolean = event.affectsConfiguration('workbench.colorTheme') || event.affectsConfiguration('editor.tokenColorCustomizations');
